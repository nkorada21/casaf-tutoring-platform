...
```ts
import { useCreateUser, useListSubjects, useCreateReview, useGetTutorProfile } from '@dataconnect/generated/react';
...
const { data, isPending, isSuccess, isError, error } = useGetTutorProfile(getTutorProfileVars);
...
```js
import { createUser, listSubjects, createReview, getTutorProfile } from '@dataconnect/generated';
...
// Operation GetTutorProfile:  For variables, look at type GetTutorProfileVars in ../index.d.ts
