...
const getTutorProfileRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetTutorProfile', inputVars);
}
getTutorProfileRef.operationName = 'GetTutorProfile';
exports.getTutorProfileRef = getTutorProfileRef;

exports.getTutorProfile = function getTutorProfile(dcOrVars, vars) {
  return executeQuery(getTutorProfileRef(dcOrVars, vars));
};
